package com.example.jdbc.repository.imp;

import com.example.jdbc.model.User;
import com.example.jdbc.repository.IUserDAO;
...
public class ConnectDB implements IUserDAO {
    ...
    private static final String PASS ="Hungvulong1@";// do cài đặt khi cài đặt mysql
    ...
    private static final String SQL_TABLE_CREATE = "CREATE TABLE EMPLOYEE"
            ...
            + " PRIMARY KEY (ID)"
            + ")";
    private static final String SQL_DELETE_SP = "CALL DELETE_USER(?);";
    private static final String SQL_SHOW_USER_SP = "CALL SHOW_LIST();";
    private static final String SQL_UPDATE_SP = "CALL UPDATE_USER(?,?,?,?);";
    ...
    public List<User> selectAllUsers() {
        ...
        try (
             ...
             PreparedStatement preparedStatement = connection.prepareStatement(SQL_SHOW_USER_SP);) {
            System.out.println(preparedStatement);
            ResultSet rs = preparedStatement.executeQuery();
    ...
    public boolean deleteUser(int id) throws SQLException {
        boolean rowDeleted;
        try (Connection connection = getConnection(); PreparedStatement statement = connection.prepareStatement(SQL_DELETE_SP);) {
    ...
    public boolean updateUser(User user) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = getConnection(); PreparedStatement statement = connection.prepareStatement(SQL_UPDATE_SP);) {
